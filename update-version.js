...
export function updateBuildVersion() {
  ...
  // Also update cache-busting query strings in index.html, ide.html, translator.html, stats.html, tools.html
  const htmlFiles = ['index.html', 'ide.html', 'translator.html', 'stats.html', 'tools.html'];
